  ...
  return (
    <>
      <motion.div
        initial="hidden"
        animate="visible"
        className="flex flex-row items-center justify-center pl-5 sm:px-20 mt-40 w-full z-[20]"
      >
        <div className="w-full h-full flex flex-col gap-5 justify-center m-auto text-start">
          ...
          >
            ...
            <h1 className="Welcome-text text-[16px] sm:text-[18px]">
          ...
          <motion.div
            ...
            className="flex flex-col gap-6 mt-6 text-3xl sm:text-6xl font-bold text-white max-w-[600px] w-auto h-auto"
          >
            <span>
              Providing
